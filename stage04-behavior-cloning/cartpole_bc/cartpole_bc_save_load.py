...
# 2. 定义 PolicyNet / expert_policy / collect_data / train_model
...
# 5. 复用 rollout：observation_to_tensor / select_action / run_one_episode
...
def main():
    ...
    total_reward,step_count=run_one_episode(loaded_model)
